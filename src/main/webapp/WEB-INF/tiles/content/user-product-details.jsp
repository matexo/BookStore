            ...
            <div class="panel-body">
                ...
                <div class="col-md-7">
                    <div class="container-fluid">
                        ...
                        <div class="col-md-6"><h4 class="text-danger pull-right">{{product.unitPrice | currency:"PLN "}}</h4></div>
                        <div style="clear: both"></div>
                        <button class="btn btn-default btn-block margin-top-20" disabled="disabled"
                                ng-hide="product.quantity > 0">
                            Produkt niedostępny
                        </button>
                        <button class="btn btn-success btn-block margin-top-20" ng-show="product.quantity > 0 && !{{isAdmin}}" ng-click="addToCart(product.bookId)">
                            Dodaj do koszyka
                        </button>
                    </div>
                </div>
